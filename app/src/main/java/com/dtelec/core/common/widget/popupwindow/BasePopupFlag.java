package com.dtelec.core.common.widget.popupwindow;
...
public interface BasePopupFlag {
    ...
    //显示控制 3 bit
    int DISPLAY_SHIFT = 3;
    int FULL_SCREEN = 0x1 << DISPLAY_SHIFT; //0001左移3位1000变为0x8，全屏（允许覆盖状态栏）
    int CLIP_CHILDREN = 0x2 << DISPLAY_SHIFT;//010左移3位0001 0000变为0x16，裁剪子控件
    int CLIP_TO_SCREEN = 0x4 << DISPLAY_SHIFT;//0x32，限制显示在屏幕内

    //popup控制 6 bit
    int CONTROL_SHIFT = 6;
    int FADE_ENABLE = 0x1 << CONTROL_SHIFT;// 0000 0001，0x64淡入淡出
