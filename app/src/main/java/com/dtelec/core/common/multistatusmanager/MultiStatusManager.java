package com.dtelec.core.common.multistatusmanager;
...
public class MultiStatusManager {
     ...
     * 默认图片
     */
    private static final int DEFAULT_EMPTY_IMG_ID = R.mipmap.status_layout_manager_ic_empty;
    private static final int DEFAULT_ERROR_IMG_ID = R.mipmap.status_layout_manager_ic_error;
    ...
    private void createEmptyLayout() {
        ...
        //设置点击事件
        final View view = emptyLayout.findViewById(emptyClickViewId);
